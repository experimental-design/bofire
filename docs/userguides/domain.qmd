...
CategoricalInput(
    ...
    descriptors={"density": [0.1, 0.3, 0.5], "hardness": [0.2, 0.4, 0.6]},
)
...
inputs = Inputs(
    ...
    DiscreteInput(key="x3", values=[0, 0.1, 0.2]),
    CategoricalInput(key="x4", categories=["A", "B", "C"]),
    CategoricalInput(key="x6", categories=["material_A", "material_B", "material_C"], descriptors={"density": [0.1, 0.3, 0.5], "hardness": [0.2, 0.4, 0.6]}),
    CategoricalInput(key="x7", categories=["C1CCCCC1", "O1CCOCC1"], structure=["C1CCCCC1", "O1CCOCC1"])])
```
