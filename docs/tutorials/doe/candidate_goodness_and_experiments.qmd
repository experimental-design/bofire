...
rank_full = strategy_fresh.get_candidate_fim_rank()
...
2. **Evaluate existing data**: Use `get_candidate_fim_rank()` to assess your candidates, if you have any that you want to incorporate
