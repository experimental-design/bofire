...
An example script for Bayesian optimisation on a molecular dataset using a Tanimoto 
fingerprint kernel and the photoswitch dataset.
...
# Benchmark - input and output feature keys and extract them to get LookUpTable
benchmark = {
    "input": "SMILES",
