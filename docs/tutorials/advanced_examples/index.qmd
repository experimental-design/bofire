...
### [Custom SOBO Strategy](custom_sobo.qmd)
Create custom single-objective Bayesian optimization strategies.

### [Desirability Functions for Multi-Objective Optimization](desirability_objectives.qmd)
...
### [Multi-fidelity Bayesian Optimization](multifidelity_bo.qmd)
Leveraging multiple fidelity levels for efficient optimization.

### [Multi-Objective, Multi-Fidelity BO](multioutput_multifidelity_bo.qmd)
Optimize multiple objectives across fidelity levels.

### [Input Features as Output Objectives](objectives_on_inputs.qmd)
...
### [Predict Motor Octane Number of Hydrocarbon Mixtures](octane_number.qmd)
Predict the motor octane number of hydrocarbon mixtures with a surrogate model.

### [Conditional Features](conditional_features_bo.qmd)
