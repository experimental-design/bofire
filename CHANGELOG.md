...
- Added `FractionalFactorialStrategy.get_required_number_of_experiments()` to return the exact number of experiments generated by the strategy for continuous, mixed, categorical/discrete-only, and blocked designs, avoiding underestimation in mixed full-factorial cases.
