...
from everest.domain.tests.utils import get_invalids
from everest.strategies.botorch.sobo import (AcquisitionFunctionEnum,
                                             ...
                                             BoTorchSoboStrategy)
from everest.strategies.botorch.tests.test_base import data, domains
...
def test_SOBO_get_fbest(domain, experiments, Strategy,expected):
    my_strategy = Strategy.from_domain(domain, acquisition_function = random.choice(list(AcquisitionFunctionEnum)))
