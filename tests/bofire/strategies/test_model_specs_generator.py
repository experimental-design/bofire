...
from bofire.strategies.strategy import ModelPredictiveStrategy, ModelSpec, Strategy
...
from tests.bofire.strategies.test_model_spec import VALID_MODEL_SPEC_SPEC
...
def test_generate_model_specs(strategy: Strategy, domain: Domain, expected_count: int):
    model_specs = ModelPredictiveStrategy._generate_model_specs(domain, strategy.model_specs)
...
def test_generate_model_specs_invalid(strategy: Strategy, domain: Domain):
    with pytest.raises(KeyError):
        ModelPredictiveStrategy._generate_model_specs(domain, strategy.model_specs)
